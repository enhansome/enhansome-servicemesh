...
* [kong](https://github.com/Kong/kong) ⭐ 44,146 | 🐛 200 | 🌐 Lua | 📅 2026-09-07 - 🐒 The Microservice API Gateway
* [dubbo](https://github.com/apache/incubator-dubbo) ⭐ 41,568 | 🐛 1,041 | 🌐 Java | 📅 2026-09-15 - Apache Dubbo (incubating) is a high-performance, java based, open source RPC framework
* [consul](https://github.com/hashicorp/consul) ⭐ 30,074 | 🐛 1,411 | 🌐 Go | 📅 2026-09-17 - Consul is a distributed, highly available, and data center aware solution to connect and configure applications across dynamic, distributed infrastructure
* [tars](https://github.com/Tencent/Tars) ⭐ 10,082 | 🐛 48 | 🌐 C++ | 📅 2026-07-18 - Tars is a highly performance rpc framework based on naming service using tars protocol and provides a semi-automatic operation platform
...
* [ambassador](https://github.com/datawire/ambassador) ⭐ 4,523 | 🐛 405 | 🌐 Python | 📅 2026-09-16 - Open source Kubernetes-native API gateway for microservices built on the Envoy Proxy
...
* [control-plane](https://github.com/envoyproxy/go-control-plane) ⭐ 1,731 | 🐛 20 | 🌐 Go | 📅 2026-09-17 - Contains a Go-based implementation of an API server that implements the discovery service APIs defined in data-plane-api
...
* [Awesome CI/CD DevOps](https://github.com/ciandcd/awesome-ciandcd) ⭐ 2,011 | 🐛 32 | 📅 2026-04-14 - A curated list of awesome tools for continuous integration, continuous delivery and DevOps
