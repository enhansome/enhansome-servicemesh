...
* [kong](https://github.com/Kong/kong) ⭐ 44,044 | 🐛 191 | 🌐 Lua | 📅 2026-08-16 - 🐒 The Microservice API Gateway
...
* [consul](https://github.com/hashicorp/consul) ⭐ 30,043 | 🐛 1,419 | 🌐 Go | 📅 2026-08-26 - Consul is a distributed, highly available, and data center aware solution to connect and configure applications across dynamic, distributed infrastructure
...
* [ambassador](https://github.com/datawire/ambassador) ⭐ 4,518 | 🐛 440 | 🌐 Python | 📅 2026-08-24 - Open source Kubernetes-native API gateway for microservices built on the Envoy Proxy
...
* [control-plane](https://github.com/envoyproxy/go-control-plane) ⭐ 1,725 | 🐛 23 | 🌐 Go | 📅 2026-08-26 - Contains a Go-based implementation of an API server that implements the discovery service APIs defined in data-plane-api
